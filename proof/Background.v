...
Proof. intros A x v. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  destruct b.
  - reflexivity.
  - symmetry in Heqb. rewrite beq_id_false_iff in Heqb.
    destruct Heqb.
    reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  destruct b.
  - destruct Hxs.
    symmetry in Heqb. rewrite beq_id_true_iff in Heqb. apply Heqb.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  intros X v1 v2 x1 x2 m. intro Hxs.
  unfold t_update.
  apply functional_extensionality.
  intros x'.
  destruct (beq_idP x1 x').
  - destruct (beq_idP x2 x').
    + rewrite e in Hxs. rewrite e0 in Hxs. destruct Hxs. reflexivity.
    + reflexivity.
  - destruct (beq_idP x2 x').
    + reflexivity.
    + reflexivity.
